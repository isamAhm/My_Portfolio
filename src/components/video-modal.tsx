...
export const VideoModal = ({ isOpen, onClose, videoUrl, title, description, tags }: VideoModalProps) => {
  ...
  return (
    ...
    >
      <div
        className="relative bg-gradient-to-br from-black via-gray-950 to-black rounded-xl max-w-4xl w-full h-[75vh] p-6 border border-blue-800 flex flex-col overflow-y-auto"
      ...
      >
        ...
        <div className="mt-4 text-start flex-none">
