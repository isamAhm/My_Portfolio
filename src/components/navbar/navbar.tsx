...
import my_cv from '../../assets/Isam_Ahmed_Resume_updated.pdf';
      ...
      style={
        isScrolled
          ? theme === 'dark'
            ...
            : { background: 'linear-gradient(to bottom, #e8f5e9, rgba(232, 245, 233, 0.8), transparent)' }
    ...
    >
      <nav className="mx-auto max-w-7xl px-4 py-4">
        <div className="flex items-center justify-between">
          <motion.a
            href="#"
            className={`flex items-center gap-2 text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'
              } z-50`}
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className={`download-cv hidden md:block px-4 py-2 ml-4 text-md font-fira-code ${theme === 'dark'
